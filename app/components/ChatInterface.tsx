      ...
      <div className="flex-1 flex flex-col min-w-0">
        <div className="flex items-center justify-between px-4 py-3 border-b border-gray-200 dark:border-gray-700 bg-gradient-to-r from-purple-50 to-pink-50 dark:from-gray-800 dark:to-gray-800">
          ...
          <button
            ...
            aria-label={apiKey ? 'APIキー設定済み - 設定を開く' : 'APIキーを設定'}
        ...
        {showSettings && (
          ...
          >
            ...
            {/* Modal */}
            <div
              className="relative bg-white dark:bg-gray-800 rounded-2xl shadow-2xl p-6 m-4 max-w-md w-full animate-bounce-in"
              role="document"
            >
