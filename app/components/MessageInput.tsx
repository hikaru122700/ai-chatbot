...
export default function MessageInput({
  ...
  return (
    <div className="border-t border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 p-4">
      ...
      {/* File error message */}
      {fileError && (
        <div className="max-w-4xl mx-auto mb-3 flex items-center gap-2 text-red-600 dark:text-red-400 bg-red-50 dark:bg-red-900/20 px-3 py-2 rounded-lg">
      ...
      <div className="max-w-4xl mx-auto flex gap-2">
        ...
        {speechSupported && (
          <button
            ...
            aria-label={isListening ? '録音停止' : '音声入力を開始'}
